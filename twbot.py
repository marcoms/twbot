...
def create_question():
	...
	if is_multiple_choice:
		...
		if (
			(correct_answer == "a" and not answers.get("a"))
			or (correct_answer == "b" and not answers.get("b"))
			or (correct_answer == "c" and not answers.get("c"))
			or (correct_answer == "d" and not answers.get("d"))
		):
			print(
		...
		for dm in dms:
			...
			if question["possible_answer_id"]:
				...
				if is_correct:
					...
					message = "Incorrect! The correct answer was " + \
